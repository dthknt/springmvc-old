...
@Repository //Indica q a classe acessa banco de dados, mera semantica pois @Component tb serviria
public class ContaDAO {
	
	private Connection connection;
	
	@Autowired //Como nao tem default constructor, marca com autowired
